                                ...
                                <v-card-text>
                                    ...
                                    <v-form>
                                        ...
                                        <v-container grid-list-xs>
                                            ...
                                            <v-row>
                                                <v-col>
                                                    ...
                                                    <p>
                                                        ...
                                                        We are interested to know why you want to delete your account.
                                                        <br>
                                                        Please leave us feedback in order to continue to improve the
                                                        application <br>
                                            ...
                                            <v-row>
                                                <v-col>
                                                    <VTextarea outlined no-resize autoGrow v-model="areaModel"
                                                        placeholder="Let us know why?..." rows=1 append="mdi-send">
                                                    </VTextarea>
                                                </v-col>
                                            </v-row>
                                            <!-- button-row -->
        ...
        <v-dialog v-model="dialog" width="500">
            <v-card>
                ...
                <v-card-text>
                    ...
                    <!-- confirm-action -->
                    <div class="mt-5">
                        Please insert <span class="font-weight-bold">{{ currentUser.username }}</span> to confirm.
                    </div>
                    <!-- confirm-field -->
                    <v-text-field v-model="confirmModel" solo hide-details background-color="grey lighten-3"
